plugins {
    ...
    // Reads google-services.json so Firebase Messaging can boot without a
    // hand-written options file.
...
android {
    namespace = "tech.hoppin.hoppin_driver"
    ...
    defaultConfig {
        ...
        applicationId = "tech.hoppin.hoppin_driver"
