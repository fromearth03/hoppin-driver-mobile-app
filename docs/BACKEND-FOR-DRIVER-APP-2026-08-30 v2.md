...
Everything asked is implemented and deployed — including the rider Recent Payments
**card brand/last4** (the payment service now captures it from Stripe at charge time;
see the rider doc). **A20** was a stale comment only — no action.
